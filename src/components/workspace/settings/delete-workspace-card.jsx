                ...
                >
                    <div className="flex flex-col items-start justify-between py-0">
                        <div className="mb-2 flex-1">
                            <p>
                                Deleting a workspace is a permanent action and cannot
                                be undone. Once you delete a workspace, all its
                                associated data, including projects, tasks, and member
                                roles, will be permanently removed. Please proceed with
                                caution and ensure this action is intentional.
                            </p>
                        </div>

                        <Button
                            className="flex h-[40px] shrink-0 place-self-end"
                            variant="destructive"
