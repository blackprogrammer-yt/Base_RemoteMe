...
const EditGeneralInvoice = () => {
    ...
    const handleRemoveItem = (itemId) => {
        if (items.length > 1) {
            ...
            delete newErrors[`description_${itemId}`];
            setErrors(newErrors);
            toast({
                title: "Item removed",
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        <div className="space-y-2">
                            ...
                            >
                                ...
                                <SelectContent>
                                    <SelectItem value="org1">Dhurandhar Casting Company</SelectItem>
...
export default EditGeneralInvoice;
